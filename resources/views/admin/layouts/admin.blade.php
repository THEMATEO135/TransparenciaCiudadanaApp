        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item" style="display: flex; align-items: center; flex-direction: column; padding: 0.5rem 1rem;">
                        <div style="color: #718096; font-size: 0.875rem; margin-bottom: 0.25rem;">
                            <i class="fas fa-user-circle"></i> {{ session('admin_email', 'admin@example.com') }}
                        </div>
                        <form action="{{ route('admin.logout') }}" method="POST" class="d-inline">
                            @csrf
                            <button type="submit" class="nav-link btn logout-btn" style="padding: 0.25rem 0.75rem; font-size: 0.875rem;">
                                🚪 Cerrar Sesión
                            </button>
                        </form>
                    </li>
